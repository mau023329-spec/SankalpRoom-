    ...
    with box:
        ...
        for msg in shown:
            ...
            with st.chat_message("assistant" if is_ai else "user"):
                ...
                # Show profile photo next to name if user has one set
                if photo and not is_ai:
                    name_html = (
                        f'<img src="{photo}" style="width:20px;height:20px;border-radius:50%;'
                        f'object-fit:cover;vertical-align:middle;margin-right:0.35rem;'
                        f'border:1px solid #1C2030;" />'
