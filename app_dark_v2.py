...
def sg_header(sg, room, user_name):
    ...
    with col_name:
        ...
        st.markdown(
            ...
            f'<div style="font-family:Space Grotesk,sans-serif;font-size:0.75rem;color:#64748B;">'
    ...
    for i, s in enumerate(stats):
        with cols[i]:
            ...
            st.markdown(
                ...
                f'<div style="color:#64748B;font-size:0.65rem;font-weight:600;text-transform:uppercase;'
