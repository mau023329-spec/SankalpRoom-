...
def get_room_by_invite(invite_code: str):
    """Fetch room name/details from an invite code — used for the invite banner."""
    return fetchone("SELECT * FROM rooms WHERE invite_code = ?", (invite_code.upper(),))
